...
import static com.example.chapter2.priorityqueues.PriorityQueueType.MIN;
...
public class MinPriorityQueueTest {
    ...
    private PriorityQueue initialise(int size) {
        return PriorityQueueFactory.create(MIN, size);
    }

    @Test
    public void checkDeletingMin() {
    ...
    @Test
    public void checkSortedOrderInMin() {
        ...
        assertTrue(new Helper().isSortedInMin(sortedInput));
    }
