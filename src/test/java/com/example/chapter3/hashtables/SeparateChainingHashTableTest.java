...
import static com.example.chapter3.hashtables.HashSymbolTableType.SEPARATE_CHAINING;
...
public class SeparateChainingHashTableTest {
    ...
    public HashSymbolTable constructDummyStringTree() {
        HashSymbolTable hashSymbolTable = HashSymbolTableFactory.get(SEPARATE_CHAINING);
    ...
    @Test
    public void init() {
        HashSymbolTable<String, String> hashSymbolTable = HashSymbolTableFactory.get(SEPARATE_CHAINING);
    ...
    public void putString() {
        HashSymbolTable<Integer, String> hashSymbolTable = HashSymbolTableFactory.get(SEPARATE_CHAINING);
    ...
    public void putAndGetForGeneric() {
        HashSymbolTable<Student, String> hashSymbolTable = HashSymbolTableFactory.get(SEPARATE_CHAINING);
